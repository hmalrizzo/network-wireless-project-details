classdef UE < handle
    ...
    properties
       ...
       %variable for UE satisfaction - Wajahat Baig 17/12/2010
       satisfaction;
    end
    ...
    methods
        ...
        function start_handover(obj,target_eNodeB,target_sector)            
            ...
            obj.attached_eNodeB.sectors(obj.attached_sector).UEs_attached_last_TTI = 0;
            obj.attached_eNodeB.sectors(obj.attached_sector).UEs_attached_last_TTI = [];
            ...
            % By doing this, it gives an error, so I have commented it out -
            % Wajahat Baig - 02/09/2010
